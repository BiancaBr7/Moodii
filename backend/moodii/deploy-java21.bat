@echo off
REM filepath: d:\Moodii\Moodii\backend\moodii\deploy-java21.bat

echo Moodii Backend - Docker Deployment (Java 21)
echo ===============================================
...
docker build -f Dockerfile -t moodii-backend-java21 .
